...
class ImageLoader(QObject):
    ...
    def __init__(self, cache_dir: str = None):
        ...
        if cache_dir is None:
            cache_dir = Path(__file__).parent.parent.parent / "assets" / "posters"
    ...
    def _get_cache_path(self, url: str) -> Path:
        ...
        hash_name = hashlib.sha256(url.encode("utf-8")).hexdigest()  # SHA256 is more secure
    ...
    def _download_image(self, url: str, cache_key: str, cache_path: Path,
        ...
        if url in self.active_downloads:
            # Add this label to the callback list
        ...
        def on_finished():
            # Get all labels waiting for this image
            ...
            if pixmap.loadFromData(data):
                ...
                # Update all waiting labels with error
                for cb_label, _, _ in callbacks:
                    cb_label.setText(error_text)
                    cb_label.setAlignment(Qt.AlignCenter)
