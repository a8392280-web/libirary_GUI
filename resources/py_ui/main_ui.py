...
################################################################################
## Form generated from reading UI file 'main_uipHAMiK.ui'
##
...
"    color: rgb(230, 230, 230);}")
        ...
        self.side_bar_button.setIcon(icon10)
        ...
        self.add_button.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/Icons/list.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon12.addFile(u":/icons/Icons/grid.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.view_button.setIcon(icon12)
        ...
        self.search_button_1.setIcon(icon13)
        ...
        self.random_button_1.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/Icons/refresh.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.refresh_button_1.setIcon(icon15)
        ...
        self.search_button_2.setIcon(icon13)
        ...
        self.random_button_2.setIcon(icon14)
        ...
        self.refresh_button_2.setIcon(icon15)
        ...
        self.search_button_3.setIcon(icon13)
        ...
        self.random_button_3.setIcon(icon14)
        ...
        self.refresh_button_3.setIcon(icon15)
        ...
        self.search_button_4.setIcon(icon13)
        ...
        self.random_button_4.setIcon(icon14)
        ...
        self.refresh_button_4.setIcon(icon15)
        ...
        self.search_button_5.setIcon(icon13)
        ...
        self.random_button_5.setIcon(icon14)
        ...
        self.refresh_button_5.setIcon(icon15)
        ...
        self.search_button_6.setIcon(icon13)
        ...
        self.random_button_6.setIcon(icon14)
        ...
        self.refresh_button_6.setIcon(icon15)
